...
export const Footer: React.FC = () => {
  return (
    <footer className="relative mt-20 py-12 px-4 md:px-6 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Company */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Best Hotel Rates</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/categories" className="text-white/70 hover:text-white text-sm transition-colors">
                  Categories
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/booking-policy" className="text-white/70 hover:text-white text-sm transition-colors">
                  Booking Policy
                </Link>
              </li>
              <li>
                <Link href="/cancellation" className="text-white/70 hover:text-white text-sm transition-colors">
                  Cancellation Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/60 text-sm">
              © 2025 Best Hotel Rates. All rights reserved.
            </p>
